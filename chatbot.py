...
def welcome():
    print("*" * 40)
    print(
        "Thanks for trying out the CryptoBot. Please keep in mind that this is an experimental Seq2Seq chatbot and may not always give a coherent output."
    )
...
class CryptoChatBot:
    ...
    def rizz_up(self):
        ...
        responses = [
            "You can ask me a crypto related question!",
            "Can I help you with a blockchain related query?",
            "How can I help you?",
        ]
    ...
    def respond(self, query):
        confused = [
            "I don't relevant information regarding this. Anything else I can help you with?",
        ...
        filtered_query = [
            word for word in query_tokens if word not in stopwords.words("english")
        ]
        filtered_query = [
            word for word in filtered_query if word not in string.punctuation
        ]
    ...
    def extract_topics(self, query):
        ...
        topics = [
            ...
            if "NN" in tag and word.lower() not in stopwords.words("english")
        ]
        return topics
